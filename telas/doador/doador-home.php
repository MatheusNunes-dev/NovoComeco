    ...
    <header>
        <nav class="navbar nav-lg-screen" id="navbar">
            ...
            <div class="nav-links" id="nav-links">
                <ul>
                    <li><button class="btn-icon-header" onclick="toggleSideBar()"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-x" viewBox="0 0 16 16">
        ...
        <section class="banner-intro">
            <div class="text-banner">
                <div class="first-line-banner">
                    <div><span class="tittle-banner">NOVO</span></div>
                    <div class="a"><a class="btn-quero-doar" href="../telas/usu-ongs.php">QUERO DOAR!</a></div>
                </div>
                <div><span class="tittle-banner">COMEÇO</span></div>
            </div>
            <div><img class="img-banner" src="../../assets/banner.png"></div>
            <div class="quero-doar"><a class="btn-quero-doar-mobile" href="queroDoar.html">QUERO DOAR!</a></div>
        </section>
        <section class="banner-cards-ongs">
            <div class="card-ong"><img class="img-ong" src="../../assets/ong-1.png"><a class="btn-conhecer" href="pagina-da-usu-ong-1.php">CONHECER</a></div>
            <div class="card-ong"><img class="img-ong" src="../../assets/ong-2.png"><a class="btn-conhecer" href="pagina-da-usu-ong-2.php">CONHECER</a></div>
            <div class="card-ong"><img class="img-ong" src="../../assets/ong-3.png"><a class="btn-conhecer" href="pagina-da-usu-ong-3.php">CONHECER</a></div>
        </section>
        <section class="banner-cards-clientes">
            <div class="card-doador">
                <p>"A solidariedade é um ato poderoso que transforma vidas. Contribuir com amor e compaixão é um pequeno gesto que pode criar um impacto enorme!"<br>Cesar Yoshio</p>
            </div>
            <div class="card-doador">
                <p>"A doação é uma maneira simples de espalhar esperança. Saber que minha contribuição pode mudar uma vida me motiva a continuar ajudando!"<br>Tiago Gorri</p>
            </div>
            <div class="card-doador">
                <p>"Ao ajudar o próximo, plantamos sementes de esperança. Cada doação traz um pouco mais de luz e faz a diferença no caminho de alguém."<br>Matheus Muller</p>
            </div>
        </section>
    </main>
    <footer>
