...
<head>
    ...
    <link rel="stylesheet" href="../../css/doador-excluir-conta.css">
</head>
        ...
        <nav class="navbar nav-lg-screen" id="navbar">
            ...
            <div class="nav-links" id="nav-links">
                <ul>
                    ...
                    <li class="nav-link"><a href="../telas/usu-index.php">HOME</a></li>
                    <li class="nav-link"><a href="../telas/usu-ongs.php">ONG'S</a></li>
                    <li class="nav-link"><a href="../telas/usu-sobre.php">SOBRE</a></li>
                    <li class="nav-link"><a href="../telas/usu-contato.php">CONTATO</a></li>
                    <li class="nav-link"><a href="../../telas/usuarios/usu-login.php">LOGIN</a></li>
                </ul>
            </div>
            <div class="user">
    ...
    <main>
        ...
        <section class="password-change">
            <form method="POST" action="../../exclusao-doador.php">
                ...
                <div class="action-buttons">
                    <button type="button" class="action-button" onclick="history.back();">Cancelar</button>
                </div>
            </form>
        </section>
    </main>
