        ...
        <section>
            ...
            <div class="grid-ongs">
                <div class="ong">
                    ...
                    <div class="btns-card">
                        <a class="btn-card" href="usu-ong-1.php">Doar</a>
                    </div>
                </div>
                ...
                <div class="ong">
                    ...
                    <div class="btns-card">
                        <a class="btn-card" href="usu-ong-2.php">Doar</a>
                    </div>
                </div>
                <div class="ong">
                    <div class="img-cards">
                    ...
                    <div class="btns-card">
                        <a class="btn-card" href="usu-ong-3.php">Doar</a>
                    </div>
                </div>
                <div class="ong">
                    <div class="img-cards">
                    ...
                    <div class="btns-card">
                        <a class="btn-card" href="usu-ong-4.php">Doar</a>
                    </div>
                </div>
                <div class="ong">
                    <div class="img-cards">
                ...
                <div class="ong">
                    ...
                    <div class="btns-card">
                        <a class="btn-card" href="usu-ong-6.php">Doar</a>
                    </div>
                </div>
            </div>
