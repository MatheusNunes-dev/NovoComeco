    ...
    <main tax`bindex="0" class="content" id="content" onclick="closeSideBar()">
        <section class="banner-intro">
            <div class="text-banner">
                <div class="first-line-banner">
                    ...
                    <div class="a">
                        <a class="btn-quero-doar" href="../telas/usu-ongs.php">QUERO DOAR!</a>
                    </div>
                </div>
                <div>
        ...
        <section class="banner-cards-ongs">
            <div class="card-ong">
                ...
                <a class="btn-conhecer" href="pagina-da-usu-ong-1.php">CONHECER</a>
            </div>
            <div class="card-ong">
                <img class="img-ong" src="../../assets/ong-2.png">
                <a class="btn-conhecer" href="pagina-da-usu-ong-2.php">CONHECER</a>
            </div>
            <div class="card-ong">
                <img class="img-ong" src="../../assets/ong-3.png">
                <a class="btn-conhecer" href="pagina-da-usu-ong-3.php">CONHECER</a>
            </div>
        </section>
